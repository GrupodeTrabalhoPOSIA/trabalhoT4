...
5. Orquestração: TRH-04 v0.1 seleciona TRH-01 v0.3 (regras), TRH-02 v0.1 (elegibilidade) ou TRH-03 v0.1 (segurança). Mistral Large é o modelo de geração; configuração exata consta no manifesto. Sem troca automática de modelo.
