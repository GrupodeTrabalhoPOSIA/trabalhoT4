...
export default function AboutPage() {
  return <article className="delivery-page about-page">
    ...
    <aside className="delivery-notice"><strong>Finalidade acadêmica e limites do protótipo</strong><p>Esta aplicação é uma demonstração acadêmica, não um canal oficial de atendimento de RH. Não aprova exceções nem toma decisões individuais. Resultados históricos e simulações são identificados; a avaliação factual e a aprovação das evidências exigem revisão humana.</p></aside>
