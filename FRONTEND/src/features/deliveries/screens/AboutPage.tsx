...
export default function AboutPage() {
  return <article className="delivery-page about-page">
    ...
    <div className="about-actions"><a className="delivery-button delivery-button--primary" href={pagePaths.overview}>Conhecer as entregas →</a><a className="delivery-button" href={pagePaths.t5}>Abrir o protótipo do T5 ↗</a></div>
    <AcademicFooter />
  </article>;
}
